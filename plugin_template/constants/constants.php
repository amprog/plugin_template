<?php
/**
 * Constants used by CAP_PLUGIN_TEMPLATE.
...
$CAP_PLUGIN_TEMPLATE_constants = array(
  "name" => "CAP Plugin Template",
  "prefix" => "PlugTemp",
  "version" => "1.0.4",
  "slug" => "cap-plugin-template",
  "class_label" => "CAP_PLUGIN_TEMPLATE",
);
