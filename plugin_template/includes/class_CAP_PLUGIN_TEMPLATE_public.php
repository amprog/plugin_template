<?php
/**
 * The public-facing functionality of the CAP_PLUGIN_TEMPLATE.
 *
...
/**
 * The public-facing functionality of the CAP_PLUGIN_TEMPLATE plugin.
 *
 ...
 */
class CAP_PLUGIN_TEMPLATE_Public
{
  /**
  ...
  public function enqueue_styles()
  {
    $public_css_files = array(
      "cap_plugin_template_public1.css",
      "cap_plugin_template_public2.css",
    );
  ...
  public function enqueue_scripts()
  {
    $public_js_files = array(
      "cap_plugin_template_public1.js",
      "cap_plugin_template_public2.js",
    );
